...
enum cc_stat bitset_setbits_range      (Bitset *bs, size_t from, size_t to);
enum cc_stat bitset_unsetbits_range    (Bitset *bs, size_t from, size_t to);
enum cc_stat bitset_flipbits_range     (Bitset *bs, size_t from, size_t to);
...
enum cc_stat bitset_left_shift         (Bitset *bs, Bitset **out);
enum cc_stat bitset_left_shift_cyclic  (Bitset *bs, Bitset **out);
enum cc_stat bitset_right_shift        (Bitset *bs, Bitset **out);
enum cc_stat bitset_right_shift_cyclic (Bitset *bs, Bitset **out);
...
enum cc_stat bitset_multi              (Bitset *bs1, Bitset *bs2, Bitset **out);
